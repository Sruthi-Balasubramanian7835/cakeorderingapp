import 'dart:ui';
import 'package:cakeorderingapp/Cakemakers/Cakemakerlogin.dart';
import 'package:cakeorderingapp/Pages/Homepage.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:cakeorderingapp/Pages/register.dart';
                  ...
                  children: <Widget>[
                    ...
                    TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Cakemakerlogin()),
                        );
                      },
                      child: Text('Cake Makers Here',style: TextStyle(color: Colors.cyanAccent),),
                    ),
                  ],
                ),
              ),
