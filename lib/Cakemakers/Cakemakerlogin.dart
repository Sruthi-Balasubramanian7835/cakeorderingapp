...
class Cakemakerlogin extends StatefulWidget {
  const Cakemakerlogin({super.key});

  @override
  State<Cakemakerlogin> createState() => _CakemakerloginState();
}

class _CakemakerloginState extends State<Cakemakerlogin> {
  ...
  void check_if_already_login() async {
    ...
    if (newofficer == false) {
      Navigator.pushReplacement(
          context, new MaterialPageRoute(builder: (context) => Cakemakerhomepage()));
    }
  }
  ...
  void _navigateToOfficerhome() async {
    if (_formKey.currentState!.validate()) {
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) => Cakemakerhomepage()));
    }
  }
  @override
